...
#say Raycast Info
#say Unit Vector
#tellraw @a { "score": { "name": "#raycast.ux", "objective": "bs.data" } }
#tellraw @a { "score": { "name": "#raycast.uy", "objective": "bs.data" } }
#tellraw @a { "score": { "name": "#raycast.uz", "objective": "bs.data" } }
#say Distance Vector
#tellraw @a { "score": { "name": "#raycast.dx", "objective": "bs.data" } }
#tellraw @a { "score": { "name": "#raycast.dy", "objective": "bs.data" } }
#tellraw @a { "score": { "name": "#raycast.dz", "objective": "bs.data" } }
#say Length Vector
#tellraw @a { "score": { "name": "#raycast.lx", "objective": "bs.data" } }
#tellraw @a { "score": { "name": "#raycast.ly", "objective": "bs.data" } }
#tellraw @a { "score": { "name": "#raycast.lz", "objective": "bs.data" } }
